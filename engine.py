...
class TetrisEngine:
	...
	def create_menu(self):
		...
		self.extetris_menu.add_separator()
		self.extetris_menu.add_command(label="Speed-Up", command=self.speed_up)
		self.extetris_menu.add_separator()
		self.extetris_menu.add_command(label="Slow-down", command=self.slow_down)
		self.extetris_menu.add_separator()
		self.extetris_menu.add_command(label="Increase Difficulty", command=lambda: self.increase_difficulty(True, False, True))
		self.extetris_menu.add_separator()
		self.extetris_menu.add_command(label="Save state", command=self.save_file)
		self.extetris_menu.add_separator()
		self.extetris_menu.add_command(label="Exit", command=self.window.quit)
		self.extetris_menu.add_separator()
		self.extetris_menu.add_command(label="About", command=self.extetricks_help)
